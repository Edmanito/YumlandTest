...
<?php else: ?>
    ...
    <div class="panier-container">
        ...
        <?php else: ?>
            ...
            <?php 
                // Calcul du vrai total final (ne peut pas être négatif)
                $totalAPayer = max(0, $totalCommande - $totalTickets); 
            ?>
            <div class="panier-footer">
                <div class="total-section">
                    ...
                    <?php if ($totalTickets > 0): ?>
                        <span class="total-label" style="color: #4caf50; margin-top: 10px;">TICKETS DE RÉDUCTION</span>
                        <span class="total-amount" style="color: #4caf50; font-weight: bold;">-<?= $totalTickets ?>€</span>
                    <?php endif; ?>

                    <span class="total-label" style="margin-top: 15px; color: #bc9c64; font-size: 1.1rem;">TOTAL À PAYER</span>
                    <span class="total-amount" style="color: #bc9c64; font-size: 1.5rem; font-weight: bold;">
                        <?= $totalAPayer ?>€
                ...
                <div class="action-buttons">
                    ...
                    <form action="paiement.php" method="POST" id="form-paiement">
                        ...
                        <input type="hidden" name="montant_tickets" value="<?= $totalTickets ?>"> <button type="submit" class="btn-gold">PASSER AU RÈGLEMENT</button>
                    </form>
                </div>
            </div>
